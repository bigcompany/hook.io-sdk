module['exports'] = function Files (client) {
  ...
  self.createReadStream = function createReadStream (path) {
    var readStream = client.request('/files/createReadStream', { json: { path: path }, stream: true, method: "GET" });
    return readStream;
  };

  self.createWriteStream = function createWriteStream (path) {
    var writeStream = client.request('/files/createWriteStream', { json: { path: path }, stream: true });
    return writeStream;
  };
